    ...
    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
      <section className="relative py-20 sm:py-28">
        ...
        >
          ...
          SEO and real estate copywriting studio
        </motion.div>
        ...
        >
          Property copy that{" "}
          <span className="text-brand-gradient">ranks, converts</span> and sells faster.
        </motion.h1>
        ...
        >
          Axcendra helps agents, brokerages and developers win search results and turn quiet
          listings into a steady flow of qualified enquiries.
        </motion.p>
        ...
        <motion.div
          ...
          animate="show"
          custom={4}
          className="mx-auto mt-16 grid max-w-3xl grid-cols-3 gap-3"
        >
          {STATS.map((s) => (
      ...
      <section className="py-8">
        <h2 className="font-display text-3xl text-foreground">What Axcendra does</h2>
        <p className="mt-2 max-w-lg text-muted-foreground">
          Four services that work together as one growth system for property brands.
        </p>
      ...
      <section className="py-16">
        ...
        >
          ...
          <p className="mt-3 max-w-xl text-sm opacity-90 sm:text-base">
            The same internal system Axcendra runs on, built as a live tracker. Four weeks, thirty
            days, ninety tasks, with autosave on every tick.
          </p>
          <Link
            to="/tracker"
