...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Axcendra 30-Day Growth Tracker | SEO & Real Estate Copy" },
      {
        name: "description",
        content:
      ...
      <div className="relative mx-auto w-full max-w-3xl px-4 pb-24 pt-8 sm:px-6">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <WeekProgress week={week} done={done} />
...
function WeekProgress({ week, done }: { week: number; done: Record<string, boolean> }) {
